...
const LandingPage = () => {
  ...
  const slides = useMemo(
    () => [
      { img: Banner1.src, tag: "Handpicked Stays" },
      { img: Banner2.src, tag: "Curated Experiences" },
      { img: Banner3.src, tag: "Smooth Transfers" },
      { img: Banner4.src, tag: "Authentic Adventures" },
    ],
    []
  );
          ...
          <div className={Style.tjNavLeft}>
            ...
            >
              <div className={Style.tjLogoWrap}>
                <img src={logo.src} alt="TrippyJiffy" className={Style.tjLogoImg} />
              </div>
            </button>
          ...
          <section id="certs" className={Style.sectionAlt}>
            ...
            <div className={Style.certsGrid}>
              <div className={Style.certCard}>
                <img className={Style.certImg} src={Certificates1.src} alt="Certificate 1" />
              </div>
              <div className={Style.certCard}>
                <img className={Style.certImg} src={Certificates2.src} alt="Certificate 2" />
              </div>
            </div>
          </section>
          ...
          <div className={Style.footerTop}>
            <div className={Style.footerBrand}>
              <div className={Style.footerLogoRow}>
                <img src={logo.src} alt="TrippyJiffy" className={Style.footerLogo} />
                <div>
