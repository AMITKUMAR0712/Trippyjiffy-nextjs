    ...
    <div className={Style.About}>
      ...
      <div className={Style.AboutBanner}>
        <div className={Style.AboutImage}>
          <img src={AboutImg.src} alt="About TrippyJiffy" />
        </div>
      </div>
        ...
        <div className={Style.AboutMeet}>
          ...
          <div className={Style.AboutFlexmeet}>
            <div className={Style.AboutWrapDisk}>
              <img src={Director.src} alt="Arpita Srivastava" />
            ...
            <div className={Style.AboutWrapDisk}>
              <img src={Director1.src} alt="Shailee Srivastava" />
        ...
        <div className={Style.AboutCertificates}>
          ...
          <div className={Style.AboutCertificatesFlex}>
            <div className={Style.AboutCertificatesLeft}>
              <img src={Certificates1.src} alt="Certificates1" />
            </div>
            <div className={Style.AboutCertificatesRight}>
              <img src={Certificates2.src} alt="Certificates2" />
            </div>
          </div>
        </div>
      </div>
